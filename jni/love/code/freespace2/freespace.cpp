...
int main(int argc, char *argv[])
{
...
#ifdef ANDROID
  __android_log_print(ANDROID_LOG_VERBOSE, "FS2", "Starting...");
#endif
  ...
  #ifdef ANDROID
  strcat(argptr, "-nospec -noglow -noenv -nonormal -noheight -nolightshafts -no_deferred -old_collision ");
  #endif
    ...
    #ifdef ANDROID
      __android_log_print(ANDROID_LOG_VERBOSE, "FS2", "Caught std::exception in main(): '%s'!", ex.what());
    #endif
		result = EXIT_FAILURE;
	} catch ( ... ) {
    ...
    #ifdef ANDROID
      __android_log_print(ANDROID_LOG_VERBOSE, "FS2", "Caught exception in main()!");
    #endif
